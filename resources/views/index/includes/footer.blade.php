      ...
      <div class="container text-center text-md-start mt-5 text-light">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 text-light">
            ...
            <p>
             KM 53 Pan Philippine Highway, Brgy. Milagrosa, Calamba Philippines
            </p>
            <p>
             +49 5723 356
            </p>
            <p>
            admissions@nu-laguna.edu.ph
            </p>
          </div>
          <!-- Grid column -->
          ...
          <p>
            <a href="#!" class="text-reset">Angeles, Aaron Mark</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Capistrano, John Ashley</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Maalat, Jose Antonio</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Narvacan, Arnold</a>
          </p>
        </div>
        <!-- Grid column -->
